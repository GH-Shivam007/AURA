              ...
              <div className="space-y-1">
                <div className="flex items-center justify-between text-sm">
                  <span className="font-medium">
                    {event.source_account.replace('ACC_', '').replace(/_/g, ' ')} → {event.dest_account.replace('ACC_', '').replace(/_/g, ' ')}
                  </span>
                  <span className={`
                ...
                <div className="text-xs text-muted-foreground">
                  {event.source_geo.country} ({event.source_geo.city}) → {event.dest_geo.country} ({event.dest_geo.city})
                </div>
